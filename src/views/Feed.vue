<template>
  <div>
    ...
    <section>
      <p>
        Mawn WP Vue is a simple template built with Vue JS that displays posts from a WordPress REST API endpoint.
        Take what you see here &amp; rip it apart to suit your needs. To improve it for everyone else, <a href="https://github.com/mawnir/wp-vue-mawn">contribute on Github</a>.
      </p>
    </section>
